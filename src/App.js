  ...
  return (
    <> 
      ...
      <Routes>
        ...
        <Route path='/players' element={<AddPlayer players={players} addPlayer={addPlayer} />} />
        <Route path='/questions' element={<Questions questions={questions} addQuestion={addQuestion} title={title} setTitle={setTitle}/>}/>
